...
#if (POWER_IP_CFG_VENDOR_ID != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_VENDOR_ID)
...
#if ((POWER_IP_CFG_AR_RELEASE_MAJOR_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (POWER_IP_CFG_AR_RELEASE_MINOR_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (POWER_IP_CFG_AR_RELEASE_REVISION_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((POWER_IP_CFG_SW_MAJOR_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION) || \
     (POWER_IP_CFG_SW_MINOR_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION) || \
     (POWER_IP_CFG_SW_PATCH_VERSION != POWER_IP_BOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION) \
    )
